...
public class CorePrompts
{
    ...
    2. If the customer is driving, ask if they need help getting to the stadium. If they do, you will provide them with directions to the stadium. Determine if the customer has given the name of location or an address. If the customer gives the name of a location,
